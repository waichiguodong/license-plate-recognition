...
class Surface(ttk.Frame):
	...
	def __init__(self, win):
		...
		ttk.Label(frame_left, text = '选择所需的车牌照片：', font = ('Arial', 20)).pack(anchor = "nw", padx = 30)
		...
		ttk.Label(frame_right1, text='车牌分割处理：', font = ('Arial', 20)).grid(column = 0, row = 0, sticky = tk.W)
		...
		from_folder_ctl = ttk.Button(frame_right2, text="选择待识别图像", width = 30, command = self.from_folder)
	...
	def from_folder(self):
		self.pic_path = askopenfilename(title="选择待识别车牌照片", filetypes=[("jpg图片", "*.jpg")])
